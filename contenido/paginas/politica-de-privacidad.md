...
seo_titulo: Política de Privacidad | Ángela García | Psicóloga Sanitaria
seo_descripcion: Política de Privacidad de la web de Ángela García, Psicóloga General Sanitaria.
borrador: true
encabezado:
...
- titulo: 1. Responsable del tratamiento
  ...
  - etiqueta: Correo electrónico
    valor: psicologa@angelagarciamarin.com
  - etiqueta: Colegio profesional
    valor: Colegio Oficial de Psicología de Castilla-La Mancha
  - etiqueta: Nº de colegiada
    valor: CM-03341
- titulo: 2. Ámbito de aplicación
  parrafos:
  - Esta Política de Privacidad se refiere al tratamiento de datos personales relacionado con el uso de este sitio web (angelagarciamarin.com) y con los contactos que se realicen a través de los canales que en él se indican.
...
- titulo: 6. Plazo de conservación
  parrafos:
  - '*[PENDIENTE: no se fija ningún plazo concreto.]*'
  - 'Criterio de partida: conservar los datos solo durante el tiempo necesario para atender la solicitud y, en su caso, durante el plazo adicional que exija la normativa. El contenido de un contacto realizado por correo, WhatsApp o teléfono no se incorporará automáticamente a la historia clínica. *[PENDIENTE: criterio concreto de conservación y eliminación.]*'
- titulo: 7. Destinatarios y proveedores
  parrafos:
  - 'Los datos podrán ser tratados por los proveedores tecnológicos que intervienen en el funcionamiento de la web y del correo electrónico:'
  lista:
